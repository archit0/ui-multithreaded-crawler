...
public class ProcessingThread implements Runnable {
    ...
    public ProcessingThread(CrawlServices crawlServices, MemoryQueue memoryQueue) {
        ...
        DBCollection project=db.getCollection("projects");

        BasicDBObject doc = new BasicDBObject("_id", this.crawlServices.projectModel.id).
                append("url", crawlServices.projectModel.baseUrl);
